...
//
//     div.innerHTML = `<h2>${simpson.name} ${simpson.surname} ${simpson.age}</h2>  <p>${simpson.info}</p> <img src="" alt="">`
//     div.appendChild(img);
// }
...
// ------------------
    ...
    //     modules.classList.add('models');
    //
    //     let ul = document.createElement('ul');
    //
    //
    //     modules.appendChild(ul);
    //     blok.append(title, element, modules);
    //     element.append(monthDuration, hourDuration);
    //
...
//     let div = document.createElement('div');
//     document.body.appendChild(div);
//     div.innerText = `${Elements.title} - ${Elements.monthDuration}`
// }
...
//
// !!!! РОзкоментувати  <form name="f1"> в HTML
